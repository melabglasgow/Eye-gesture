...
def run2(commd):
    # Get the block and run the game logic
    if not(a.done) and not(a.game_over):
        a.get_block()
        a.game_logic(commd)
        a.draw_game()
    if a.game_over:
